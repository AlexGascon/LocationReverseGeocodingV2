 ...
 */
public class voluntariado_persona implements  Serializable {
    ...
    public voluntariado_persona(String fecha, String nombre_creador, String informacion, Double latitud_localizacion, Double longitud_localizacion, String titulo, int recordatorio, int cantidadMax, int cantidad) {
        this.fecha = fecha;
